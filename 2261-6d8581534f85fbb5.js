                ...
                let c = r > a ? "next" : "prev",
                    ...
                    p = () => {
                        ...
                        let e = Math.max(Math.min((t - o) / d, 1), 0),
                            s = a + (.5 - Math.cos(e * Math.PI) / 2) * (r - a);
                        if (u(s, r) && (s = r), i.wrapperEl.scrollTo({
                                [l]: s
                            }), u(s, r)) {
        ...
        2261: function(e, t, i) {
                ...
                p = e => {
                    ...
                    if (e.params.rewind || e.params.loop)
                        for (let s = r - t; s <= l + t; s += 1) {
                            ...
                            for (let s = Math.max(r - t, 0); s <= Math.min(l + t, i - 1); s += 1) s !== r && (s > l || s < r) && u(e, s)
                };
            ...
            function m(e) {
                ...
                Object.assign(s, {
                    ...
                    isScrolling: void 0,
                    startMoving: void 0
                }), l.startX = m, l.startY = v, s.touchStartTime = (0, o.d)(), this.allowClick = !0, this.updateSize(), this.swipeDirection = void 0, r.threshold > 0 && (s.allowThresholdMove = !1);
                let g = !0;
            ...
            function v(e) {
                ...
                if (r.isScrolling && this.emit("touchMoveOpposite", u), void 0 === r.startMoving && (n.currentX !== n.startX || n.currentY !== n.startY) && (r.startMoving = !0), r.isScrolling) {
                    r.isTouched = !1;
                    return
                }
            ...
            function g(e) {
                ...
                let n = "touchend" === l.type || "touchcancel" === l.type;
                if (n) {
                ...
                if (["pointercancel", "pointerout", "pointerleave", "contextmenu"].includes(l.type)) {
                    let e = ["pointercancel", "contextmenu"].includes(l.type) && (s.browser.isSafari || s.browser.isWebView);
                    if (!e) return
                }
                ...
                if (s.allowClick) {
                    ...
                    s.updateClickedSlide(e && e[0] || l.target, e), s.emit("tap click", l), f < 300 && h - r.lastClickTime < 300 && s.emit("doubleTap doubleClick", l)
                }
                ...
                if (r.isTouched = !1, r.isMoved = !1, r.startMoving = !1, i = a.followFinger ? c ? s.translate : -s.translate : -r.currentTranslate, a.cssMode) return;
                ...
                for (let e = 0; e < u.length; e += e < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup) {
                    ...
                    void 0 !== u[e + t] ? (m || i >= u[e] && i < u[e + t]) && (v = e, g = u[e + t] - u[e]) : (m || i >= u[e]) && (v = e, g = u[u.length - 1] - u[u.length - 2])
                }
                let w = null,
                    S = null;
                ...
                if (f > a.longSwipesMs) {
                    ...
                    let e = s.navigation && (l.target === s.navigation.nextEl || l.target === s.navigation.prevEl);
                    e ? l.target === s.navigation.nextEl ? s.slideTo(v + T) : s.slideTo(v) : ("next" === s.swipeDirection && s.slideTo(null !== w ? w : v + T), "prev" === s.swipeDirection && s.slideTo(null !== S ? S : v))
                }
            }
            ...
            let E = (e, t) => {
                    ...
                    i[d]("touchstart", e.onDocumentTouchStart, {
                        ...
                        passive: !0
                    }), (s.preventClicks || s.preventClicksPropagation) && r[d]("click", e.onClick, !0), s.cssMode && l[d]("scroll", e.onScroll), s.updateOnWindowResize ? e[t](n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", w, !0) : e[t]("observerUpdate", w, !0), r[d]("load", e.onLoad, {
                        capture: !0
                    })
                },
            ...
            let M = {
                    ...
                    update: {
                        ...
                        updateSlides: function() {
                            ...
                            for (let r = 0; r < h; r += 1) {
                                let l;
                                if (e = 0, p[r] && (l = p[r]), C && t.grid.updateSlide(r, l, p), !p[r] || "none" !== (0, o.m)(l, "display")) {
                            ...
                            if (t.virtualSize = Math.max(t.virtualSize, n) + w, a && d && ("slide" === s.effect || "coverflow" === s.effect) && (r.style.width = `${t.virtualSize+T}px`), s.setWrapperSize && (r.style[t.getDirectionLabel("width")] = `${t.virtualSize+T}px`), C && t.grid.updateWrapperSize(e, f), !s.centeredSlides) {
                                let e = [];
                        ...
                        updateSlidesProgress: function(e) {
                            ...
                            for (let e = 0; e < i.length; e += 1) {
                                ...
                                f && (this.visibleSlides.push(a), this.visibleSlidesIndexes.push(e), i[e].classList.add(t.slideVisibleClass)), h && i[e].classList.add(t.slideFullyVisibleClass), a.progress = s ? -d : d, a.originalProgress = s ? -c : c
                            }
                        },
                    ...
                    slide: {
                        slideTo: function(e, t, i, s, r) {
                            ...
                            if (n.animating && d.preventInteractionOnTransition || !v && !s && !r) return !1;
                        ...
                        slideToLoop: function(e, t, i, s) {
                            ...
                            let r = this,
                                l = r.grid && r.params.grid && r.params.grid.rows > 1,
                                n = e;
                            if (r.params.loop) {
                        ...
                        slidePrev: function(e, t, i) {
                            ...
                            let v = 0;
                            if (void 0 !== m && ((v = n.indexOf(m)) < 0 && (v = s.activeIndex - 1), "auto" === r.slidesPerView && 1 === r.slidesPerGroup && r.slidesPerGroupAuto && (v = Math.max(v = v - s.slidesPerViewDynamic("previous", !0) + 1, 0))), r.rewind && s.isBeginning) {
                    ...
                    loop: {
                        loopCreate: function(e) {
                            ...
                            let r = () => {
                                ...
                                d = l && t.slides.length % i.grid.rows != 0,
                                c = e => {
                                    for (let s = 0; s < e; s += 1) {
                        ...
                        loopFix: function(e) {
                            ...
                            c.length < v + w ? (0, o.r)("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : S && "row" === f.grid.fill && (0, o.r)("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                            let b = [],
                                T = [],
                                y = d.activeIndex;
                                ...
                                if (b.length > 0 && x) {
                                    if (void 0 === t) {
                                        let e = d.slidesGrid[y],
                                            t = d.slidesGrid[y + C],
                                            i = t - e;
                                        a ? d.setTranslate(d.translate - i) : (d.slideTo(y + C, 0, !1, !0), r && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - i, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - i))
                                    } else if (r) {
                                    ...
                                    if (void 0 === t) {
                                        let e = d.slidesGrid[y],
                                            t = d.slidesGrid[y - M],
                                            i = t - e;
                                        a ? d.setTranslate(d.translate - i) : (d.slideTo(y - M, 0, !1, !0), r && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - i, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - i))
                                    } else {
                    ...
                    events: {
                        attachEvents: function() {
                            ...
                            this.onTouchStart = m.bind(this), this.onTouchMove = v.bind(this), this.onTouchEnd = g.bind(this), this.onDocumentTouchStart = y.bind(this), e.cssMode && (this.onScroll = b.bind(this)), this.onClick = S.bind(this), this.onLoad = T.bind(this), E(this, "on")
                        },
                    ...
                    breakpoints: {
                        setBreakpoint: function() {
                            ...
                            let h = d.direction && d.direction !== s.direction,
                                ...
                                m = s.loop;
                            h && i && e.changeDirection(), (0, o.t)(e.params, d);
                            ...
                            }), p && !v ? e.disable() : !p && v && e.enable(), e.currentBreakpoint = n, e.emit("_beforeBreakpoint", d), i && (f ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !m && g ? (e.loopCreate(t), e.updateSlides()) : m && !g && e.loopDestroy()), e.emit("breakpoint", d)
                        },
            ...
            class k {
                constructor() {
                    let e, t;
                    for (var i, s = arguments.length, n = Array(s), c = 0; c < s; c++) n[c] = arguments[c];
                    1 === n.length && n[0].constructor && "Object" === Object.prototype.toString.call(n[0]).slice(8, -1) ? t = n[0] : [e, t] = n, t || (t = {}), t = (0, o.t)({}, t), e && !t.el && (t.el = e);
                    let u = (0, a.g)();
            ...
            function L(e, t) {
                ...
                Object.keys(t).filter(e => 0 > i.indexOf(e)).forEach(i => {
                    void 0 === e[i] ? e[i] = t[i] : _(t[i]) && _(e[i]) && Object.keys(t[i]).length > 0 ? t[i].__swiper__ ? e[i] = t[i] : L(e[i], t[i]) : e[i] = t[i]
                })
            }
                ...
                F = (0, n.forwardRef)(function(e, t) {
                    ...
                    let {
                        ...
                        let i = {
                            ...
                            s = {},
                            r = {};
                        L(i, C), i._emitClasses = !0, i.init = !1;
                        let l = {},
                            n = O.map(e => e.replace(/_/, "")),
                            a = Object.assign({}, e);
                        return Object.keys(a).forEach(a => {
                            void 0 !== e[a] && (n.indexOf(a) >= 0 ? _(e[a]) ? (i[a] = {}, r[a] = {}, L(i[a], e[a]), L(r[a], e[a])) : (i[a] = e[a], r[a] = e[a]) : 0 === a.search(/on[A-Z]/) && "function" == typeof e[a] ? t ? s[`${a[2].toLowerCase()}${a.substr(3)}`] = e[a] : i.on[`${a[2].toLowerCase()}${a.substr(3)}`] = e[a] : l[a] = e[a])
                    ...
                    let Y = () => {
                        Object.assign(P.on, R), c = !0;
                        let e = { ...P
                        };
                        if (delete e.wrapperClass, S.current = new k(e), S.current.virtual && S.current.params.virtual.enabled) {
                            ...
                            L(S.current.params.virtual, e), L(S.current.originalParams.virtual, e)
                        }
                    };
                    ...
                    return (0, n.useEffect)(() => () => {
                        ...
                        if (t && (t.current = w.current), w.current) return S.current.destroyed && Y(),
                            function(e, t) {
                                ...
                                I(t) && s && r && (a.params.navigation.nextEl = s, a.originalParams.navigation.nextEl = s, a.params.navigation.prevEl = r, a.originalParams.navigation.prevEl = r), A(t) && l && (a.params.pagination.el = l, a.originalParams.pagination.el = l), z(t) && n && (a.params.scrollbar.el = n, a.originalParams.scrollbar.el = n), a.init(i)
                            }({
                                el: w.current,
                                nextEl: y.current,
                                prevEl: E.current,
                        ...
                        let e = function(e, t, i, s, r) {
                            ...
                            let a = O.filter(e => "_" === e[0]).map(e => e.replace(/_/, ""));
                            return a.forEach(i => {
                                if (i in e && i in t) {
                                    if (_(e[i]) && _(t[i])) {
                        ...
                        }($, b.current, H, T.current, e => e.key);
                        return b.current = $, T.current = H, e.length && S.current && !S.current.destroyed && function(e) {
                            let t, i, s, r, l, n, a, o, {
                                    swiper: d,
                                    slides: c,
                                    passedParams: u,
                            ...
                            if (p.includes("loop") && d.isElement && (w.loop && !u.loop ? n = !0 : !w.loop && u.loop ? a = !0 : o = !0), g.forEach(e => {
                                    if (_(w[e]) && _(u[e])) Object.assign(w[e], u[e]), ("navigation" === e || "pagination" === e || "scrollbar" === e) && "enabled" in u[e] && !u[e].enabled && x(e);
                                    else {
                                        let t = u[e];
                                        (!0 === t || !1 === t) && ("navigation" === e || "pagination" === e || "scrollbar" === e) ? !1 === t && x(e): w[e] = u[e]
                                    }
                                }), g.includes("controller") && !i && d.controller && d.controller.control && w.controller && w.controller.control && (d.controller.control = w.controller.control), p.includes("children") && c && y && w.virtual.enabled ? (y.slides = c, y.update(!0)) : p.includes("virtual") && y && w.virtual.enabled && (c && (y.slides = c), y.update(!0)), p.includes("children") && c && w.loop && (o = !0), t) {
                                let e = E.init();
                                e && E.update(!0)
                            }
                    ...
                    }(S.current, H, h) : H.map((e, t) => n.cloneElement(e, {
                        swiper: S.current,
                        swiperSlideIndex: t
                    })), W["wrapper-end"]), I(P) && n.createElement(n.Fragment, null, n.createElement("div", {
                        ref: E,
            ...
            let R = (0, n.forwardRef)(function(e, t) {
                ...
                }))), !a && n.createElement($.Provider, {
                    value: w
                }, S(), o && !m && n.createElement("div", {
                    className: "swiper-lazy-preloader"
                })))
            });
            R.displayName = "SwiperSlide"
        }
    }
]);