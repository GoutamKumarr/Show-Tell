                ...
                var e, a, o, f, s, h, d, c = {
                        ...
                        4646: function(t) {
                            ...
                            r("ERR_INVALID_OPT_VALUE", function(t, e) {
                                ...
                                var n, a, o, f, s;
                                let h, d;
                                if ("string" == typeof e && (n = "not ", e.substr(!a || a < 0 ? 0 : +a, n.length) === n) ? (h = "must not be", e = e.replace(/^not /, "")) : h = "must be", o = " argument", (void 0 === f || f > t.length) && (f = t.length), t.substring(f - o.length, f) === o) d = `The ${t} ${h} ${i(e,"type")}`;
                                else {
                            ...
                            t.exports = function() {
                                ...
                                return t = [{
                                    ...
                                    value: function(t) {
                                        ...
                                        for (var e, r, i = a.allocUnsafe(t >>> 0), n = this.head, o = 0; n;) e = n.data, r = o, a.prototype.copy.call(e, i, r), o += n.data.length, n = n.next;
                                        return i
                                    }
                                }, {
                                    key: "consume",
                        ...
                        8442: function(t, e, r) {
                            ...
                            t.exports = function() {
                                ...
                                var l = d.map(function(t, n) {
                                    var a, f, h, c, p, b = n < d.length - 1;
                                    return f = a = function(t) {
                                            e || (e = t), t && l.forEach(s), b || (l.forEach(s), u(e))
                                        }, h = !1, a = function() {
                                            h || (h = !0, f.apply(void 0, arguments))
                                        }, c = !1, t.on("close", function() {
                                            c = !0
                        ...
                        3225: function(t, e, r) {
                            ...
                            n(c, a), c.prototype._update = function() {
                                for (var t, e, r, i, n, a, c, l, p, b, m, v, y, g, _, w, M, S, k, E, A, x, R, I, B, P, T, C, j, O, D, N, q, L, z, U, K, H, F, V, W, Z, X, G, J, Y, $, Q, tt, te, tr, ti, tn, ta, to, tf, ts, th, td, tc, tu, tl, tp, tb, tm, tv, ty, tg, t_, tw, tM, tS, tk = 0; tk < 16; ++tk) o[tk] = this._block.readInt32LE(4 * tk);
                                for (var tE = 0 | this._a, tA = 0 | this._b, tx = 0 | this._c, tR = 0 | this._d, tI = 0 | this._e, tB = 0 | this._a, tP = 0 | this._b, tT = 0 | this._c, tC = 0 | this._d, tj = 0 | this._e, tO = 0; tO < 80; tO += 1) tO < 16 ? (t = tE, e = tA, r = tx, i = tR, n = tI, tM = u(t + (e ^ r ^ i) + o[f[tO]] + 0 | 0, h[tO]) + n | 0, l = tB, p = tP, b = tT, m = tC, v = tj, tS = u(l + (p ^ (b | ~m)) + o[s[tO]] + 1352829926 | 0, d[tO]) + v | 0) : tO < 32 ? (_ = tE, w = tA, M = tx, S = tR, k = tI, tM = u(_ + (w & M | ~w & S) + o[f[tO]] + 1518500249 | 0, h[tO]) + k | 0, x = tB, R = tP, I = tT, B = tC, P = tj, tS = u(x + (R & B | I & ~B) + o[s[tO]] + 1548603684 | 0, d[tO]) + P | 0) : tO < 48 ? (j = tE, O = tA, D = tx, N = tR, q = tI, tM = u(j + ((O | ~D) ^ N) + o[f[tO]] + 1859775393 | 0, h[tO]) + q | 0, U = tB, K = tP, H = tT, F = tC, V = tj, tS = u(U + ((K | ~H) ^ F) + o[s[tO]] + 1836072691 | 0, d[tO]) + V | 0) : tO < 64 ? (X = tE, G = tA, J = tx, Y = tR, $ = tI, tM = u(X + (G & Y | J & ~Y) + o[f[tO]] + 2400959708 | 0, h[tO]) + $ | 0, te = tB, tr = tP, ti = tT, tn = tC, ta = tj, tS = u(te + (tr & ti | ~tr & tn) + o[s[tO]] + 2053994217 | 0, d[tO]) + ta | 0) : (ts = tE, th = tA, td = tx, tc = tR, tu = tI, tM = u(ts + (th ^ (td | ~tc)) + o[f[tO]] + 2840853838 | 0, h[tO]) + tu | 0, tb = tB, tm = tP, tv = tT, ty = tC, tg = tj, tS = u(tb + (tm ^ tv ^ ty) + o[s[tO]] + 0 | 0, d[tO]) + tg | 0), tE = tI, tI = tR, tR = u(tx, 10), tx = tA, tA = tM, tB = tj, tj = tC, tC = u(tT, 10), tT = tP, tP = tS;
                                var tD = this._b + tx + tC | 0;
                                this._b = this._c + tR + tj | 0, this._c = this._d + tI + tB | 0, this._d = this._e + tE + tP | 0, this._e = this._a + tA + tT | 0, this._a = tD
                        ...
                        6911: function(t, e, r) { /*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */
                            var i = r(4300),
                                n = i.Buffer;
